 ...
 */
final class TenantService extends EntityService
{
    /**
     ...
     * @param string $entity
     */
    public function __construct(EntityManagerInterface $manager, ParameterService $parameterService, RequestStack $requestStack, TokenStorageInterface $tokenStorage, LoaderCollection $loaderCollection, UnloaderCollection $unloaderCollection, string $entity = Tenant::class)
    {
     ...
     * </code>
     */
    public function load(Tenant $tenant): TenantService
    {
        $this->disable('tenant');
     ...
     * @throws Exception
     */
    public function unload(Tenant $tenant): TenantService
    {
        $this->disable('tenant');
        $connection = $this->manager->getConnection();
        $connection->beginTransaction();
