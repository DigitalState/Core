...
use Ds\Component\Security\Voter\DeletedVoter;
use LogicException;
...
class DeletedListener
{
    ...
    /**
     * @var \Ds\Component\Security\Voter\DeletedVoter
     */
    protected $deletedVoter;

    /**
     * Constructor
     *
     * @param \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface $tokenStorage
     * @param \Ds\Component\Security\Voter\DeletedVoter $deletedVoter
     */
