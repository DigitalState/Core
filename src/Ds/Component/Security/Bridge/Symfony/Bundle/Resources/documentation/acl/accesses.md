...
An access card contains an assignee and refers to who is inheriting the access card. The assignee may contain a direct assignment, such as aa user, or an indirect assignement, such as a role, etc.
